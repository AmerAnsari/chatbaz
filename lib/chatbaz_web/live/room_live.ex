defmodule ChatbazWeb.RoomLive do
  use ChatbazWeb, :live_view
  require Logger
  ...
  def mount(%{"id" => room_id}, _session, socket) do
    ...
    if connected?(socket) do
      ChatbazWeb.Endpoint.subscribe(topic)
      ChatbazWeb.Presence.track(self(), topic, username, %{})
    end
  ...
  def handle_event("submit_message", %{"chat" => %{"message" => message}}, socket) do
    ...
    ChatbazWeb.Endpoint.broadcast(socket.assigns.topic, "new-message", message)
  ...
  def handle_info(%{event: "presence_diff", payload: %{joins: joins, leaves: leaves}}, socket) do
    ...
    leave_messages =
      ...
      user_list = ChatbazWeb.Presence.list(socket.assigns.topic) |> Map.keys()
